...
exports.initializeWebContainer = void 0;
var api_1 = require("@webcontainer/api");
// Inicializar la autenticación de WebContainer
var initializeWebContainer = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, api_1.auth.init({
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error initializing WebContainer API:', error_1);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.initializeWebContainer = initializeWebContainer;
